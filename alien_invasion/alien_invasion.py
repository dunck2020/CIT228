...
class AlienInvasion:
    ...
    def _update_aliens(self):
        """check if the fleet is at an edge, update positions of all aliens in fleet"""
    ...
    def _check_events(self):
        """Listen and respond to keyboard and mouse events"""
    ...
    def _check_play_button(self, mouse_pos):
        """Start new game when play clicks Play"""
    ...
    def _check_bullet_alien_collision(self):
        """Respond to alien and bullet collision"""
        # Remove any bullets and aliens that have collided
        collisions = pygame.sprite.groupcollide(self.bullets, self.aliens, True, True)

        if not self.aliens:
            # destroy existing bullets and creat enew fleet
            self.bullets.empty()
            self._create_fleet()
